...
"Backend module of choice" - currently defaulted to SDL2 [Installation Guide](https://docs.gamepencil.com/docs/modules/SDL2.md)
...
### [Build via SDL2 modules](https://docs.gamepencil.com/modules/SDL2.md)
...
### [Build via raylib modules](https://docs.gamepencil.com/modules/raylib.md)
